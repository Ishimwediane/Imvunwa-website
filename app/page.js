...
export default function Home() {
  return (
    <div className="overflow-hidden">
      ...
      <section className="px-4 py-[70px] sm:px-6 lg:py-24" style={{ background: "#f8f6f1" }}>
        <div className={shell}>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group flex flex-col rounded-2xl p-7 shadow-sm border border-black/10 hover:bg-black hover:border-black hover:shadow-xl transition-all duration-300 cursor-pointer" style={{ background: "#fdfbf8" }}>
      ...
      <section style={{ background: "#f8f6f1" }} className="overflow-hidden pl-4 pr-0 py-[70px] sm:pl-6 lg:py-20">
        {/* Centered heading */}
          ...
          <div className="relative flex items-center">
            ...
            <div className="relative w-[58%] flex-shrink-0 overflow-hidden rounded-2xl">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, rgba(248,246,241,0) 0%, rgba(248,246,241,0) 40%, rgba(248,246,241,0.7) 80%, rgba(248,246,241,0.97) 100%)",
                }}
              />
            </div>
